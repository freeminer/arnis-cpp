...
void generate_doors(crate::world_editor::WorldEditor &editor,
		crate::osm_parser::ProcessedNode const &element)
{
	if (element.tags.find("door") != element.tags.end() ||
			element.tags.find("entrance") != element.tags.end()) {
