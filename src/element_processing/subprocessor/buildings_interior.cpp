...
inline std::optional<Block> get_interior_block(char c, bool is_layer2, Block wall_block) {
    switch (c) {
        case ' ': return {};                     // Nothing
        case 'W': return wall_block;             // Use the building's wall block for interior walls
        case 'U': return OAK_FENCE;              // Oak Fence
        case 'S': return OAK_STAIRS;             // Oak Stairs
        case 'B': return BOOKSHELF;              // Bookshelf
        case 'C': return CRAFTING_TABLE;         // Crafting Table
        case 'F': return FURNACE;                // Furnace
        case '1': return RED_BED_NORTH_HEAD;     // Bed North Head
        case '2': return RED_BED_NORTH_FOOT;     // Bed North Foot
        case '3': return RED_BED_EAST_HEAD;      // Bed East Head
        case '4': return RED_BED_EAST_FOOT;      // Bed East Foot
        case '5': return RED_BED_SOUTH_HEAD;     // Bed South Head
        case '6': return RED_BED_SOUTH_FOOT;     // Bed South Foot
        case '7': return RED_BED_WEST_HEAD;      // Bed West Head
        case '8': return RED_BED_WEST_FOOT;      // Bed West Foot
        case 'L': return CAULDRON;               // Cauldron
        case 'A': return ANVIL;                  // Anvil
        case 'P': return OAK_PRESSURE_PLATE;     // Pressure Plate
        case 'D': {
        ...
        case 'J': return NOTE_BLOCK;             // Note block
        case 'G': return GLOWSTONE;              // Glowstone
        case 'N': return BREWING_STAND;          // Brewing Stand
        case 'T': return WHITE_CARPET;           // White Carpet
        case 'E': return OAK_LEAVES;             // Oak Leaves
        case 'O': return COBWEB;                 // Cobweb
        case 'a': return CHISELLED_BOOKSHELF_NORTH; // Chiseled Bookshelf
        case 'b': return CHISELLED_BOOKSHELF_EAST;  // Chiseled Bookshelf East
        case 'c': return CHISELLED_BOOKSHELF_SOUTH; // Chiseled Bookshelf South
        case 'd': return CHISELLED_BOOKSHELF_WEST;  // Chiseled Bookshelf West
        case 'M': return DAMAGED_ANVIL;          // Damaged Anvil
        case 'Q': return SCAFFOLDING;            // Scaffolding
        default:  return {};                     // Default case for unknown characters
    }
}
