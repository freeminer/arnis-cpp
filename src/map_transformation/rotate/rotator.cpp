...
std::pair<double, double> rotate_point(double x, double z, double cx, double cz,
        ...
        XZBBox &xzbbox)
{
    ...
    xzbbox.min_x_ = static_cast<int>(std::floor(min_x));
    xzbbox.min_z_ = static_cast<int>(std::floor(min_z));
    xzbbox.max_x_ = static_cast<int>(std::ceil(max_x));
    xzbbox.max_z_ = static_cast<int>(std::ceil(max_z));
}
